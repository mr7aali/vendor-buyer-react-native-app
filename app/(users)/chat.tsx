            ...
            <View style={styles.listWrap}>
              {filteredRows.length ? (
                ...
                const partner =
                  ...
                  conversation?.buyer ||
                  {};
                const participantList = Array.isArray(
                  ...
                  : Array.isArray(conversation?.users)
                    ? conversation.users
                    : [];
                const participantOther = participantList.find(
                  (p: any) =>
                    resolveEntityId(p) && resolveEntityId(p) !== currentUserId,
                );
                const lastSenderId = resolveEntityId(
                  conversation?.lastMessage?.senderId ||
                    conversation?.lastMessage?.sender,
                );
                const lastReceiverId = resolveEntityId(
